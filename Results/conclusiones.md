...
* 🛠️ **Optimización de la Cadena de Suministro**: Al cruzar tablas de productos y proveedores, identifiqué la importancia de detectar valores nulos (`is null`), lo cual es vital para alertar sobre productos que carecen de un proveedor asignado en el sistema.
